...
class LoadConfigTests(unittest.TestCase):
    ...
    def test_empty_config(self):
        ...
        with open('./tests/empty_config.cfg', 'w') as f:
            json.dump({}, f)
        cfg = la.reload_config(la.config)
...
class FindLatestLogTests(unittest.TestCase):
    ...
    def test_latest_gz(self):
        ...
        self.assertEqual(file_info.date, 20190105)
    ...
    def test_latest_plain(self):
        ...
        self.assertEqual(file_info.date, 20190103)
...
class AnalyzeTest(unittest.TestCase):
    ...
    def test_file_format_error(self):
        ...
        with self.assertRaises(la.WrongFileToParseException):
    ...
    def test_integral(self):
        ...
        output_file = 'tests/log_integral/report-20170630.html'
